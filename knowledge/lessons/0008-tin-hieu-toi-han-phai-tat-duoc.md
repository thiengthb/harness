...
occurrences: 4
evidence:
  - "PR #105 / `.claude/learnings/2026-W32` §1 — `/harness-propose` đỏ vì đếm MỌI dòng từng có trong `gate-fails.log`. Ba lần chặn ngày 2026-08-07 đều đã xử lý xong; không lệnh nào làm nó xanh lại. Sửa bằng `TELEMETRY_CLOSED` + `openTelemetryEntries()`"
