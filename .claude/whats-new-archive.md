<!--
  LƯU TRỮ của .claude/whats-new.md — hồ sơ ĐẦY ĐỦ, append-only.

  File này KHÔNG nằm trong SEED của apply-to.mjs, nên nó KHÔNG chảy xuống repo tiêu thụ. Đó là
  cả lý do nó tồn tại: `whats-new.md` phải ngắn (session-start chỉ in ~700 ký tự) NHƯNG lịch sử
  thông báo là hồ sơ, và harness-doctor xếp nó cùng nhóm với changelog/ADR/learnings — thứ
  KHÔNG được viết lại.

  Xoay vòng: khi whats-new.md vượt trần, cắt các mục cũ nhất và dán LÊN ĐẦU phần dưới đây.
-->

# Lưu trữ thông báo harness
